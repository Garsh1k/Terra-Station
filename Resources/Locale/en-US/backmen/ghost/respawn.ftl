...
ghost-respawn-window-rules-footer = Не забудьте поменять своего персонажа перед тем, как зайти в игру. Вы можете понести наказание, если зайдете за того же самого персонажа. Вы не имеете права помнить что-либо из памяти своего прошлого персонажа.
